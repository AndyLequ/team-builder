...
let teamMembers = [
  {
    id: getId(), firstName: "Alice", lastName: "Smith",
...
I love creating intuitive and visually appealing web interfaces."
  ...
  {
    id: getId(), firstName: "Bob", lastName: "Johnson",
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if(editing == null){
      ...
      const { firstName, lastName, bio } = members.find(mem => mem.id == editing)
      setValues({ firstName, lastName, bio })
    }
  }, [editing])
  ...
  const submitNewMember = () => {
    ...
    const newMember = { firstName, lastName, bio, id: getId() }
      ...
      <div id="membersForm">
        ...
        <form onSubmit={onSubmit}>
          <div>
            ...
            <input onChange={onChange} value={values.firstName} id="firstName" type="text" placeholder="Type First Name" />
          </div>

          <div>
            <label htmlFor="lastName">Last Name </label>
            <input onChange={onChange} value={values.lastName} id="lastName" type="text" placeholder="Type Last Name" />
          </div>
